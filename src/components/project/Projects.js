    ...
    <>
      ...
      <div className={classes.container}>
        <Project
          ...
          description={
            "An e-commerce app comes with a built-in cart and checkout feature, providing you with a seamless and hassle-free shopping experience. Easily add items to your cart, review your selections, and securely checkout with just a few taps."
          }
        />
        <Project
          image={starfinder}
